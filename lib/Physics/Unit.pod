...
expresses how large it is in terms of the unprefixed base units B<gram>, B<meter>, and
B<second>.
...
=item C<InitUnit($nameList1, $unitDef1, $nameList2, $unitDef2, ...)>
